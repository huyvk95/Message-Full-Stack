...
function ContentFooterComponent({ navigation, chooseContentTab }: IFooterComponentProps) {
    ...
    return (
        <div className="content-footer px-3 pt-2">
            <div className={`footer-item ${tab === EContentTap.CONVERSATION ? "active" : ""}`} onClick={() => { chooseContentTab(EContentTap.CONVERSATION) }}>
                <div className="item-content">
                    <i className="fa fa-comment" />
                    <p className="text-bold">Chats</p>
                </div>
            </div>
            <div className={`footer-item ${tab === EContentTap.PEOPLE ? "active" : ""}`} onClick={() => { chooseContentTab(EContentTap.PEOPLE) }}>
                <div className="item-content">
